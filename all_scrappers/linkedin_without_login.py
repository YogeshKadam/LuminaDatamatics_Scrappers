...
class LinkedinSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        urls=[
#["1","https://www.linkedin.com/in/shruti-patel-73a876b3"],
#["2","https://www.linkedin.com/in/sylvia-bateman-46178020"],
#["3","https://www.linkedin.com/in/jadedavisesq"],
#["4","https://www.linkedin.com/in/keith-koford-abba98117"],
#["5","https://www.linkedin.com/in/christina-ibrahim-7668746"],
["6","https://www.linkedin.com/in/thomasianderson"],
]
        #list=[]
        for url in urls:
            ...
            req=scrapy.Request(url[1] ,callback=self.parse1)
            req.meta['id']=url[0]
            ...
            #req.cookies={'bcookie':"v=2&e05dda29-c820-4650-8373-3ed9e858cd8e", 'bscookie':"v=1&20180606070922414dfe25-4954-42a4-8f7b-f04af257c141AQGK97-GaBlmNcLuVdDOq96FO93JyI5c", '_ga':'GA1.2.1454141722.1528268939', 'lang':"v=2&lang=en-us", 'sl':"v=1&cW3xB", 'liap':'true', 'JSESSIONID':"ajax:2237063414829956073", 'li_at':'AQEDASeMOT0CTE5DAAABY9PuVMEAAAFj9_rYwU0ArvzEqcz2nmFNDU54calGg1F-EPd6xUtAGpJt4evOyPKBvTrjjT4H5zqFtLnDub3Cp2-2lj4InIKxYKCR1z-t3cJsSKINQub1VxsYeMhX8M1px4gd', 'visit':"v=1&M", '_guid':'4c64a23c-52c1-4866-bc74-3ad09611535d', 'sdsc':'1%3A1SZM1shxDNbLt36wZwCgPgvN58iw%3D', 'lidc':"b=SB17:g=88:u=4:i=1528452252:t=1528532188:s=AQEFmSLBDzZnQKhvV-k-pcd9YApH1F6v", '_lipt':'CwEAAAFj3w9xQ5TyW97_nuCFKXIicBgZbOx38oqdijZlA4I-57FONkspvnRdIW-mzuOzylwdOzR2zv4BCrZXeCjR_wMfV-zt8OqDj4RK7ndGktsQennx8fhf'}
            ...
            #req.cookies={'lidc':"b=VGST09:g=754:u=1:i=1529922026:t=1530008426:s=AQHxrzZXDW9C6hPIXRhbISaIBfOC6Wdf", 'rtc':'AQGsrIUT0OAhMwAAAWQ2dXoQDL-uuAlGOi2-IB2AfWfb5_ozbwWA6P-1fEjfyBWojru0MlWHVUPYNarpOIB7UqhMjvaN1_2cP9vM3TWK2MWVMLeTHKbdDDEDoTYP3P-uNdUhQC4WdpA39jfJV7T_8z9vDZiAvTFp7jK6beQFMTNkOgR75ymESWnC4FhRqfwm97oULKMszIDMXJELMe2AZR1xMP_jqzlOZzf-IhgMDyXZgfjBl0yt30FdsQ4ZUYCsTF0UfE1U', 'JSESSIONID':'ajax:2442717768016184894', 'bcookie':"v=2&b8943c0f-21ff-4e54-8dd4-f778d52162d8", 'bscookie':"v=1&201806251020260aa52f1a-1242-46d6-8d97-3074e5a4d1dcAQGeVTHzHcBEHjRSMdhFi8ooVdfDzWeX", 'visit':"v=1&G", 'lang':"v=2&lang=en-us", 'leo_auth_token':"GST:895JWR8sPmc0EP74lfOmszffz56NCyNJk4OvurUjhSccx-7mMCcpCd:1529922027:c9fb31cc02c431a30a6ff065acd381bf1995d809", 'RT':'s=1529922037640&r=https%3A%2F%2Fwww.linkedin.com%2Fauthwall%3Ftrk%3Dgf%26trkInfo%3DAQH8brF3cSVpTgAAAWQ2dXoQla-Z9Vjud4tcNQ6py3uqjixBaI6JWR1-5P6m4OSrZfZvjpjHIu-uRrBRqgUmOuz29eZI0APkIRQSivQlFor4VaGlD5pTV8PLxV3KuoYjfZFeXYI%3D%26originalReferer%3Dhttps%3A%2F%2Fwww.google.co.in%2F%26sessionRedirect%3Dhttps%253A%252F%252Fwww.linkedin.com%252Fin%252Fthomas-f-anderson'}
            if url[0] not in urls_done: yield req

    def parse1(self,response):
        f=open("linkedin_without_login.html","w")
        f.write(response.body)
        f.close()
        """data=response.xpath('//code[25]//text()').extract()[0]
        data=demjson.decode(data)
        #print data
        #for key,value in data['included'].items():
        fnames=[fname for fname in data['included'] if fname.has_key("firstName") if fname.has_key("locationName")]
        names= [{'firstName':dicts["firstName"],'lastName':dicts["lastName"],'Occupation':dicts["headline"],'Location':dicts["locationName"]} for dicts in fnames]
        ...
        for dict3 in names:
            ...
            yield item
        #f=open("linkedin_search_keyword2505111.txt","w")
        #f.write(response.body)
        #f.close()"""