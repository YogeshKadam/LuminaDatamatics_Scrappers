...
class PacerSpider(scrapy.Spider):
    imgcount = 1
    name = "pacer_scrapper_19-10-2018_part1"
    allowed_domains = []
...
["43","https://ecf.wawb.uscourts.gov/cgi-bin/WrtOpRpt.pl"],
    ...
    def parse6(self, response):
        ...
        form_data={'all_case_ids':'0', 'case_num':'', 'last_name':'', 'first_name':'', 'middle_name':'', 'office':'', 'nsuit':'', 'case_type':'', 'cause':'', 'case_flags':'', 'filed_from':'9/12/2018', 'filed_to':'10/12/2018', 'ShowFull':'1', 'Key1':'cs_sort_case_numb', 'UserType':''}
