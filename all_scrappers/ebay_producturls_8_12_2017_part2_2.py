...
class EbaySpider(scrapy.Spider):
    imgcount = 1
    name = "ebay_producturls_8_12_2017_part2_2"
    allowed_domains = []
    ...
    #start_urls = ["https://stackoverflow.com/questions/10152131/how-do-i-index-the-3-highest-values-in-a-list"]

    def parse(self,response):
        urls_done = [
]
        urls=[
"https://www.ebay.com/b/Mens-Jeans/11483/bn_694325?",
]
