...
"8",
        ...
        urls=[
["1","/Staples-Composition-Notebooks-Marble-Wide-Ruled/product_SS1031502"],
["2","/Gartner-Studios-Invitation-Envelope/product_SS3656585"],
["3","/Staples-Inkjet-Postcards/product_SS1028006"],
["4","/Mead-Five-Star-Reinforced-Filler-Paper/product_SS2709411"],
["5","/Avery-Laser-Inkjet-Embossed-Tent-Cards/product_SS466045"],
["6","/Avery-Laser-Inkjet-Notecards/product_SS951631"],
["7","/Staples-Reinforced-Filler-Paper/product_SS1025706"],
["8","/Staples-Pastel-Filler-Paper/product_SS1075319"],
["9","/Blueline-Executive-Journals-Black/product_SS985684"],
["10","/Eccolo-Black-Leather-Journals/product_SS1064598"],
]
        for url in urls:
    ...
    def parse1(self, response):
        variants_list=response.xpath('//*[@id="STP--Skuset-dropdown"]/div[2]/ul/li/a/@href').extract()
        if not variants_list: variants_list=response.xpath('//*[@id="STP--Skuset-dropdown"]/div/ul/li/a/@href').extract()
        #print "variantslist :",variantslist
        for variants in variants_list:
            item=StapleItems()
            item['variant_url']="https://www.staples.com"+variants
